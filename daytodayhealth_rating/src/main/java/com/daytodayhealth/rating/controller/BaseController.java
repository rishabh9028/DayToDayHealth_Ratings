...
import com.daytodayhealth.rating.exception.BaseAbstract;
...
public class BaseController extends BaseAbstract implements MessageSourceAware {
	...
	public ModelMapper modelMapper() {
		...
		modalMapper.getConfiguration().setPropertyCondition(Conditions.isNotNull());
		modalMapper.getConfiguration().setAmbiguityIgnored(true);
		return modalMapper;
	}
}